...
reqq = urllib2.Request("http://fattanza.no-ip.org/progettoTW/vicinoa/ltw1129-palestrern/params/40/10/")
...
for id,value in locations.items():
	...
	output += "INSERT INTO locations(name,category,address,latitude,longitude,opening,closing) VALUES ('%s','%s','%s','%s','%s','%s','%s');\n" % (name, category,address,lat,long,opening,closing)
